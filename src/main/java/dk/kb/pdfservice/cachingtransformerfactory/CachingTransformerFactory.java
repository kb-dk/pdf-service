...
public class CachingTransformerFactory extends TransformerFactory {
    ...
    private final CacheLoader<StreamSourceWrapper, Templates>
            cacheLoader
            = new CacheLoader<StreamSourceWrapper, Templates>() {
        @Override
    ...
    public CachingTransformerFactory() {
        try {
            ...
            TransformerFactory delegate = (TransformerFactory) Class.forName(delegateClazz)
